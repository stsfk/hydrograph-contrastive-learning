...
# Read the CSV files
training_data = pd.read_csv('data/training_data_camels_de.csv')
validation_data = pd.read_csv('data/validation_data_camels_de.csv')
test_data = pd.read_csv('data/test_data_camels_de.csv')
